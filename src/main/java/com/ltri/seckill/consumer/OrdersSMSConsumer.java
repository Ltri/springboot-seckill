...
@Component
@Slf4j
@RocketMQMessageListener(topic = "topic-orders-pay", consumerGroup = "group-orders-sms")
public class OrdersSMSConsumer implements RocketMQListener<PayDTO> {
    @Autowired
    ...
    public void onMessage(PayDTO dto) {
        ...
        log.info("模拟短信服务 订单id:{}", dto.getOrdersId());
        //接收流水表插入
